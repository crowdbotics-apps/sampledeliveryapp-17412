"""myfoodapp_17412 URL Configuration
...
admin.site.site_header = "SampleDeliveryApp"
admin.site.site_title = "SampleDeliveryApp Admin Portal"
admin.site.index_title = "SampleDeliveryApp Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="MyFoodApp API",
        default_version="v1",
        description="API documentation for MyFoodApp App",
    ),
    public=True,
